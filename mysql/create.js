...
database.query(createPetCategoryQuery, (err, result) => {
  if (err) {
    throw err;
  } else {
...
database.query(createPetQuery, (err, result) => {
  if (err) {
    throw err;
  } else {
...
database.query(createStoreOrderQuery, (err, result) => {
  if (err) {
    throw err;
  } else {
...
database.query(createUserQuery, (err, result) => {
  if (err) {
    throw err;
  } else {
